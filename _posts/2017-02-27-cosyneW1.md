...
layout: post
comments: true
title: The Cosyne Workshops, day 1: Deep Learning and Comp Neuro
...
This was, once again, a talk about the general vision the speaker had of the field and its aim (that's also because I didn't really keep any notes about the technical parts). I liked the evolutionary ideas at the beginning, which, I'd say, complement and justify Yoshua Bengio's approach to understanding the brain. It was the talk I enjoyed the most, at least for today.
...
This refers to the fancy receptive fields learned by deep networks in the various layers. According to Konrad Koerding, even if we recorded all receptive fields of all neurons, we still wouldn't understand representations. We need to understand the brain in terms of learning, of cost functions.
